...
class ManufacturerModel(db.Model):
    ...
    manufacturer = db.Column(db.String(20), db.ForeignKey('manufacturer.name'), primary_key=True)
...
def populate_manufacturer_model(*args, **kwargs):
    db.session.add(ManufacturerModel(manufacturer='Boeing', model='747-8'))
    db.session.add(ManufacturerModel(manufacturer='Boeing', model='767'))
    db.session.add(ManufacturerModel(manufacturer='Boeing', model='777'))
    db.session.add(ManufacturerModel(manufacturer='Airbus', model='A220'))
    db.session.add(ManufacturerModel(manufacturer='Airbus', model='A330'))
    db.session.add(ManufacturerModel(manufacturer='Airbus', model='A350'))
    db.session.commit()
...
class Airplane(db.Model):
    ...
    __table_args__ = (db.ForeignKeyConstraint([manufacturer, model],
                                           [ManufacturerModel.manufacturer, ManufacturerModel.model]), {}
                      )
